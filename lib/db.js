...
async function connectDB() {
  ...
  // Register the underlying MongoClient with Vercel's pool manager so
  // connections are properly drained when a function suspends or is recycled.
  // attachDatabasePool requires the real MongoClient, not a plain wrapper —
  // Mongoose exposes it via getClient() after a successful connect.
